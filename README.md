...
2. Edit `.env`: set `EXPLORE_VERSION=0.1.5`, a `POSTGRES_PASSWORD` (for example from `openssl rand -hex 24`) and `EXPLORE_PUBLIC_URL`. The file explains the optional settings.
