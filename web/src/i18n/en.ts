...
export const en: Dict = {
  ...
  submit: {
    ...
    probe: "Fetch blog info",
    probing: "Fetching info and checking feed…",
    previewTitle: "Blog Preview",
    previewDesc: "Successfully fetched blog details. Review and adjust below if needed:",
    name: "Blog name",
    desc: "Description",
    discoveredFeed: "Feed URL",
    latestPost: "Latest post",
    articlesCount: "Valid articles",
    confirmButton: "Confirm and submit",
    reprobeButton: "Fetch again",
