...
// simple-icons' colors where it has the mark; Halo's is its icon's average.
const colors = {
  wordpress: '#21759B',
  halo: '#0771DF',
  hugo: '#FF4088',
...
const WordPressMark = mark('0 0 24 24', { fill: colors.wordpress }, [
...
const HaloMark = mark('0 0 669 875', { fill: colors.halo }, [
...
const HugoMark = mark('0 0 24 24', { fill: colors.hugo }, [
...
const HexoMark = mark('0 0 24 24', { fill: colors.hexo }, [
...
const JekyllMark = mark('0 0 24 24', { fill: colors.jekyll }, [
...
const KiteMark = mark('7.5 7.25 49 49', { fill: colors.kite, stroke: colors.kite, strokeWidth: 5, strokeLinejoin: 'round' }, [
