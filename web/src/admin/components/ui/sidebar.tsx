...
const SIDEBAR_STORAGE_KEY = 'explore_admin_sidebar'
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      writePreference(SIDEBAR_STORAGE_KEY, String(openState))
    },
    [setOpenProp, open]
  )
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className='sr-only'>
            ...
            <SheetDescription>后台页面导航</SheetDescription>
          </SheetHeader>
...
/** The saved expanded state, or true when nothing is stored. */
function readSidebarOpen() {
  return readPreference(SIDEBAR_STORAGE_KEY) !== 'false'
}
